...
<tbody>
    ...
    <tr>
    <tr>
    <td>sent date</td><td><?php echo $sentdate; ?> </td>
    </tr>
        <td>delivered date</td><td><?php echo $deldate; ?> </td>
    </tr>
...
<?php } ?>
 ...
 <input type="submit" name="delete_delivery" value="remove transaction">
</form>
...
{
            $query = "DELETE  FROM delivered WHERE id=$order_id";
        $query1=mysqli_query($link,$query);
        if($query1)
        {
